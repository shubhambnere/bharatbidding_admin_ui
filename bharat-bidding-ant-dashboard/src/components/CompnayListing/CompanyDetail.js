...
const CompanyDetail = () => {
    ...
    useEffect(() => {
        // Fetch Company details and Company data here
        // ...

        // Set Company data to form fields
        if (CompanyData) {
            form.setFieldsValue({
            ...
            <Row gutter={16}  justify="space-evenly" >
                ...
                <Col xs={24} sm={24} md={24} lg={16} xl={16}>
                    <Card style={{ padding: 10, marginRight: -10, marginLeft: -10, marginBottom: 0 }}>
                        ...
                        <Row gutter={[16, 16]}>
                            <Col xs={{ span: 24, offset: 0 }} lg={{ span: 12, offset: 0 }} >
                                <Form.Item name="Companys_deal_in" label="Companys Deal In">
                                    <Select mode="multiple" placeholder="Select Companys...">
                                        {/* Map and render options */}
                                        <Option value={'ss'}>{'CompanyName'}</Option>
                                        <Option value={'ss1'}>{'CompanyName1'}</Option>
                                        <Option value={'ss2'}>{'CompanyNam3e'}</Option>
                                        <Option value={'ss4'}>{'CompanyName4'}</Option>
                                    </Select>
                                </Form.Item>
                            </Col>
                            <Col xs={{ span: 24, offset: 0 }} lg={{ span: 12, offset: 0 }} >
