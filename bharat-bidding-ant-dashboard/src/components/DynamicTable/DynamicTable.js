    ...
    },
    {
      ...
      render: (_, record) => (
        <span style={{ display: 'flex', justifyContent: 'space-between',}}>
          ...
          >
            <Icon icon={editIcon} width={16} height={16} style={{display:'flex', justifySelf:'center', margin:0  }} />
          </Button>
          ...
          >
            <Icon icon={trashFill} width={16} height={16} style={{display:'flex', justifySelf:'center', margin:0  }} />
          </Button>
        </span>
      ),
    },
